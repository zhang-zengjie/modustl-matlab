...
subplot(2, 1, 1)
hold on
fill([1, 5, 5, 1], [0, 0, 3, 3], [0.9, 0.9, 0.9]);
line([1, 1], [0, 3], 'LineStyle', '--', 'color', [0.2, 0.2, 0.2]);
line([5, 5], [0, 3], 'LineStyle', '--', 'color', [0.2, 0.2, 0.2]);
p1 = plot(T(1:L), Y(3,1:L), 'color', [0, 0, 0.8], 'LineWidth', 1.5, 'LineStyle', '-.');
ylabel('X-axis');
grid on
axis([0, 5, 0, 3]);
hold off
...
fill([1, 5, 5, 1], [0, 0, 1, 1], [0.9, 0.9, 0.9]);
...
p2 = plot(T(1:L), Y(4,1:L), 'color', [0, 0, 0.8], 'LineWidth', 1.5, 'LineStyle', '-.');
ylabel('Y-axis');
grid on
axis([0, 5, 0, 1]);
xlabel('time');
