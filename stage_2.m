...
Sys.stl_list = {'alw_[0,5] ev_[0,5] ( abs(y1(t)-4) < 1)', ...
                ...
                'alw_[0,5] ( ( abs(y1(t)-8) < 1) or ev_[0,5] ( abs(y1(t)-8) < 1))', ...
                'alw_[0,5] ( ( abs(y2(t)-6) < 1) or ev_[0,5] ( abs(y2(t)-6) < 1))', ...
                'alw_[5,5] ( (y1(t) < 14) and (y1(t) > 2) )', ...
                'alw_[5,5] ( (y2(t) < 7) and (y2(t) > 1) )'};

% Sys.stl_list = {'alw_[0,5] ev_[0,5] ( abs(y1(t)-4) < 1)', ...
%                 'alw_[0,5] ev_[0,5] ( abs(y2(t)-6) < 1)', ...
%                 'alw_[0,5] ( ( abs(y1(t)-8) < 1) or ev_[0,5] ( abs(y1(t)-8) < 1))', ...
%                 'alw_[0,5] ( ( abs(y2(t)-6) < 1) or ev_[0,5] ( abs(y2(t)-6) < 1))', ...
%                 'ev_[0,5] alw_[0,1] ( abs(y1(t)-8) < 1)', ...
%                 'ev_[0,5] alw_[0,1] ( abs(y2(t)-2) < 1)', ...
%                 'alw_[5,5] ( (y1(t) < 14) and (y1(t) > 2) )', ...
%                 'alw_[5,5] ( (y2(t) < 7) and (y2(t) > 1) )'};
